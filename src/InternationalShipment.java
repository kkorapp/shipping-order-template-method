public class InternationalShipment extends ShipmentOrder {
    ...
    public InternationalShipment(String orderNumber, String customerName, double distanceKm, double baseFee, boolean insured,
                                 String destinationCountry, boolean customsDocumentsRequired, boolean expressDelivery) {
    ...
    protected double calculateAdditionalFee() {
        ...
        if (customsDocumentsRequired) fee += 45;
        if (expressDelivery) fee += 80;
